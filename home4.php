...
if ($checked = 'both'){ ?>
      ...
      <br>
      <span>  
      <input id="searchSite5"  type="radio"   name="site2"    value="site:http://nhlbi-public:8087/" >Public
      <input id="searchSite4"  type="radio"   name="site2"    value="site:http://nhlbi:8087/" >Private
      <input id="searchSite6" type="radio"   name="site2"  checked="1"  value="" >Both Sites
      </span>
      ...
      <input id="searchSite3" type="radio"   name="site"  checked="1"  value="" >No Filter
      </span>
...
$("input:radio[id=searchSite4]").click(function(){
var name = $("#searchTerm").val();
